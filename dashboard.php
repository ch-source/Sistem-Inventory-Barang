...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_supplier">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="dashboard.php?p=data_stok_opname">Data Stok Opname</a>
            ...
            <a class="collapse-item" href="dashboard.php?p=data_return_barang">Data Return Barang</a>
          </div>
        </div>
      </li>
      </li>
       <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="dashboard.php?p=laporan_supplier">Laporan Supplier</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_barang">Laporan Barang</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_stok_barang">Laporan Stok Barang</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_stok_opname">Laporan Stok Opname</a>
            <a class="collapse-item" href="
            dashboard.php?p=laporan_barang_masuk">Laporan Barang Masuk</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_barang_keluar">Laporan Barang Keluar</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_return_barang">Laporan Return Barang</a>
          </div>
        </div>
      </li>
    </ul>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="dashboard.php?p=data_warga">
                  <div class="mr-3">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> CV. Ana Ikat |  Design By: <b><a href="https://indrijunanda.gitlab.io/" target="_blank">indrijunanda</a></b>

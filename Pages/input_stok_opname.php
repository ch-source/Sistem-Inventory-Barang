          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Form Input Stok Opname</h6>
                </div>
                <div class="card-body">
                  <form method="post" action="proses_simpan_opname.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="stok" readonly="readonly"  name="stok" required="required">
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="so" name="so" required="required">
                      </div>
                    </div>
                    <div class="form-group row">

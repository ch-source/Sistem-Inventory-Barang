            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  include"koneksi.php";
                  $id=$_GET['id'];
                  $query_a="SELECT * FROM tbl_supplier WHERE id_supplier='$id'";
                  $sql_a=mysqli_query($connect, $query_a);
                  $data_a=mysqli_fetch_array($sql_a);?>
                   <form method="post" action="proses_edit_supplier.php?id=<?php echo $id;?>" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama</label>
                      <div class="col-sm-10">
                        <input type="text"  name="nama" class="form-control" value="<?php echo $data_a['nama_supplier'];?>" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Perusahaan</label>
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo $data_a['nama_perusahaan'];?>" class="form-control" name="np" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Tgl. Masuk</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php echo $data_a['tgl_masuk'];?>" name="tgl" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">

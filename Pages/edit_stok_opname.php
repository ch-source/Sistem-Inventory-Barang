            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Form Edit Stok Opaname</h6>
                </div>
                <div class="card-body">
                  <?php
                  include"koneksi.php";
                  $id=$_GET['id'];
                  $query_a="SELECT * FROM tbl_stok_opname WHERE id_opname='$id'";
                  $sql_a=mysqli_query($connect, $query_a);
                  $data_a=mysqli_fetch_array($sql_a);?>
                   <form method="post" action="proses_edit_stok_opname.php?id=<?php echo $id;?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="tgl_barang_masuk" readonly="readonly"  name="tbm" required="required">
                      </div>
                      <label class="col-sm-2 col-form-label">Stok Awal</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_a['stok'];?>" id="stok" readonly="readonly"  name="stok">
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Tgl. Stok Opname</label>
                      <div class="col-sm-4">
                        <input type="date" class="form-control" name="tgl" required="required">
                      </div>
                      <label class="col-sm-2 col-form-label">Stok Opname</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_a['stok_opname'];?>" id="so" name="so" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Selisih</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="selisih" name="selisih" readonly="readonly">
                      </div>
                      <label class="col-sm-2 col-form-label">Keterangan</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_a['keterangan'];?>" name="ktr" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">

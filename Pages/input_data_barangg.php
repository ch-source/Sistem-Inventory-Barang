                ...
                <div class="card-body">
                  <form method="post" action="proses_simpan_barang.php" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                       <select id="nim" name="nim" class="form-control"  autofocus="autofocus" onchange="changeValueNIM(this.value)">
                             ...
                             <?php 
                               $sql=mysqli_query($connect, "SELECT * FROM tbl_supplier WHERE status_validasi='Valid'");
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" id="nama_supplier" readonly="readonly"  name="ns" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" id="nama_kategori" readonly="readonly"  name="naka" required="required">
                      </div>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" id="nama_merek" readonly="readonly"  name="nm" required="required">
                      </div>

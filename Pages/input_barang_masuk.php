                ...
                <div class="card-body">
                  <form method="post" action="proses_simpan_barang_masuk.php" enctype="multipart/form-data">
                       ...
                       <select id="nim" name="nim" class="form-control"  autofocus="autofocus" onchange="changeValueNIM(this.value)">
                             ...
                             <?php 
                               ...
                               while ($data=mysqli_fetch_array($sql)) {
                                ...
                                $jsArray .= "prdName['" . $data['id_barang'] . "'] = {nama_supplier:'" . addslashes($data['nama_supplier']) . "', nama_perusahaan:'" . addslashes($data['nama_perusahaan']) . "', nama_kategori:'" . addslashes($data['nama_kategori']) . "', nama_merek:'" . addslashes($data['nama_merek']) . "', satuan:'" . addslashes($data['satuan']) . "'};\n";
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="so" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">

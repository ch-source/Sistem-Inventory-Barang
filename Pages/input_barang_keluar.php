                       ...
                       <select id="nim" name="nim" class="form-control"  autofocus="autofocus" onchange="changeValueNIM(this.value)">
                             ...
                             <?php 
                               ...
                               while ($data=mysqli_fetch_array($sql)) {
                                ...
                                $jsArray .= "prdName['" . $data['id_barang'] . "'] = {nama_supplier:'" . addslashes($data['nama_supplier']) . "', nama_perusahaan:'" . addslashes($data['nama_perusahaan']) . "', nama_kategori:'" . addslashes($data['nama_kategori']) . "', nama_merek:'" . addslashes($data['nama_merek']) . "', stok:'" . addslashes($data['stok']) . "', satuan:'" . addslashes($data['satuan']) . "'};\n";

                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select name="karyawan" class="form-control" required="required">
                          ...
                          <?php 
                        $query="SELECT * FROM tbl_karyawan WHERE status_user=''";
                        $sql=mysqli_query($connect, $query);
                        while($data1=mysqli_fetch_array($sql)){
                        echo"<option value='".$data1['id_karyawan']."''>".$data1['id_karyawan']."-".$data1['nama_karyawan']."</option>";
                      }
                      ?>
                        </select>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select name="jabatan" class="form-control" required="required">
                          ...
                          <option value="Owner">Owner</option>option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row">

                  ...
                  <table class="table align-items-center table-hover table-bordered" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                         ...
                         <td style="text-align: center;"><a href="dashboard_owner.php?p=edit_kategori&id=<?php echo $data_user['id_kategori'];?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                         </td>
                      </tr>
                      <?php $no++;}
                      ?>

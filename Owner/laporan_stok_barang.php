<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Laporan Stok Barang</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-md-12" style="margin-bottom: 5px;">
              <div class="card">
                <div class="card-header">
                  <b class="card-title">Laporan Stok Barang</b>
                </div>
                <div class="card-body">
                   <form method="post" action="laporan/laporan_stok_barang_x.php" target="_blank">

<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Laporan Barang Masuk</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-md-12" style="margin-bottom: 5px;">
              <div class="card">
                <div class="card-header">
                  <b class="card-title">Laporan Data Barang Masuk</b>
                </div>
                <div class="card-body">
                   <form method="post" action="laporan/laporan_barang_masuk_x.php" target="_blank">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tabel Data Laporan Barang Masuk</h6>
                </div>
                <div class="card-body">

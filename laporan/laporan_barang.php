...
$pdf->SetX(1.6);
$pdf->SetFont('Times','i',10);
$pdf->MultiCell(22.5,0.6,"Laporan Barang: ".$ta."- ".$ak,0,'L'); 
...
$pdf->Cell(5, 0.6, 'ID Barang', 1, 0, 'C');
$pdf->Cell(6, 0.6, 'Nama Supplier', 1, 0, 'C');
$pdf->Cell(6, 0.6, 'Kategori', 1, 0, 'C');
$pdf->Cell(5, 0.6, 'Merek', 1, 0, 'C');
$pdf->Cell(4, 0.6, 'Tanggal', 1, 1, 'C');
...
while($lihat=mysqli_fetch_array($tampil)){
    ...
    while ($data1=mysqli_fetch_array($sql1)) {
        $pdf->Cell(5, 0.6, $lihat['id_barang']."-".$lihat['nama_barang'],1, 0, 'L');
    }
    $pdf->Cell(6, 0.6, $lihat['nama_supplier'],1, 0, 'L');
    $pdf->Cell(6, 0.6, $lihat['nama_kategori'],1, 0, 'L');
    $pdf->Cell(5, 0.6, $lihat['nama_merek'],1, 0, 'L');
    $pdf->Cell(4, 0.6, $lihat['tgl_barang_masuk'],1, 1, 'L');
    $no++;
}
...
$pdf->Cell(23, 0.8,"Jumlah Barang",1, 0, '');

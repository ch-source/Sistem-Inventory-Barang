...
$pdf->SetX(1.6);
$pdf->SetFont('Times','i',10);
$pdf->MultiCell(22.5,0.6,"Laporan Barang Keluar: ".$ta."- ".$ak,0,'L'); 
...
$pdf->Cell(3, 0.6, 'Kategori', 1, 0, 'C');
$pdf->Cell(3, 0.6, 'Merek', 1, 0, 'C');
$pdf->Cell(3, 0.6, 'P/T', 1, 0, 'C');
$pdf->Cell(3, 0.6, 'Tgl. Barang Keluar', 1, 0, 'C');
$pdf->Cell(3, 0.6, 'Jml. Barang', 1, 1, 'C');

$no=1;
$sql="SELECT * FROM tbl_barang_keluar WHERE tgl_barang_keluar between '$ta' AND '$ak'";
...
while($lihat=mysqli_fetch_array($tampil)){
    ...
    $pdf->Cell(3, 0.6, $lihat['nama_kategori'],1, 0, 'L');
    $pdf->Cell(3, 0.6, $lihat['nama_merek'],1, 0, 'L');
    $pdf->Cell(3, 0.6, $lihat['periode']."-".$lihat['tahun'],1, 0, 'L');
    $pdf->Cell(3, 0.6, $lihat['tgl_barang_keluar'],1, 0, 'L');
    $pdf->Cell(3, 0.6, $lihat['jml_barang_keluar'],1, 1, 'L');
    $no++;
}
$pdf->SetFont('Times','B',7);
$order="SELECT * FROM tbl_barang_keluar WHERE tgl_barang_keluar between '$ta' AND '$ak'";
...
$pdf->Cell(25, 0.8,"Jumlah Barang Keluar",1, 0, '');
$pdf->Cell(3, 0.8, $count ,1, 1, 'C');
